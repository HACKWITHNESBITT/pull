...
<Callout type="tip" title="Read with a question">
  Do not read BOLTs cover-to-cover first. Open the BOLT that matches your bug (invoice
  decode, channel open, onion) and keep Mastering Lightning nearby for narrative.
</Callout>
