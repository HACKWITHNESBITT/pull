...
<Callout type="info" title="ACK / NACK">
  In Bitcoin Core and related projects, reviewers often write **ACK** (I support this
  after review) or **NACK** (I object, with reasons). Silence is not approval. Expect
  technical pushback, it is normal.
</Callout>
